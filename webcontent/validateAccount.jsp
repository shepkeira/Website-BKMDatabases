...
<%
	...
	if(authenticatedUser != null) {
		...
		response.sendRedirect("createaccount.jsp");		// Failed login - redirect back to login page with a message 
	}
%>
...
<%!
	String validateLogin(JspWriter out,HttpServletRequest request, HttpSession session) throws IOException
	{
		...
		try 
		{
			...
			while(rslt.next()) {
				String userName = rslt.getString("userid");
				if(userName.equals(user)) {
					return null;
				}
			}  
			String insert = "INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password) VALUES (\'" + first +"\', \'" + last+ "\', \'" + email + "\', \'" + phoneNum + "\', \'" + address + "\', \'" + city + "\', \'" + state + "\', \'" + postal + "\', \'" + country + "\', \'" + user + "\', \'" + pass + "\');";
